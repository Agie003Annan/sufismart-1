...
class _ProductListViewState extends State<ProductListView>{
  ...
  Widget build(BuildContext context) {    
    return BaseView<ProductViewModel>(
      onModelReady: (model) => model.getDataProductList(context,widget.categoryproduct),
                                      ...
                                      return InkWell(
                                        onTap: () {
                                          ...
                                          Navigator.push(
                                              ...
                                              MaterialPageRoute(
                                                builder: (context) =>
                                                    ProductTypeView(productCode:model.productList[index].productCode,productImage:model.productList[index].productImage,),
                                              ));
                                        },
                                        child: Card(  
                                          child: Column(
                                              ...
                                              Container(
                                                ...
                                                decoration: BoxDecoration(
                                                  ...
                                                  image: DecorationImage(
                                                      image: AssetImage("assets/images/logo_suzuki.png"), fit: BoxFit.cover),
                                                ),
                                              ) : CachedNetworkImage(
                                            ...
                                            SizedBox(height: 5,),                                                                                        
                                              ...
                                              Container(
                                                //text kepanjangan jadi titik-titik
                                                width: MediaQuery.of(context).size.width,
                                                padding: const EdgeInsets.only(top: 0.0, bottom: 10.0, right: 10.0, left: 10.0),
                                                // child: Text(
                                                          ...
                                                          child:Row(
                                                            ...
                                                            children: <Widget>[
                                                              Text(
                                                                ...
                                                                Text(
                                                                  model.productList[index].productPrice,
                                                                  style: TextStyle(
                                                                      color: Colors.black,
                                                                      fontSize: 18,
                                                                      fontWeight: FontWeight.bold),
